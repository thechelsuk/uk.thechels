...
| pip-audit | Python package | Python package security auditing |
...
**Total Python Packages:** 21

## Summary

- **Ruby Gems:** 75 packages
- **Python Packages:** 21 packages
...
- `pip-audit` for Python package security checking
