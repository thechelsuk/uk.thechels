...
Having seen discourse on bubbles.town about bloggers using week notes and it being seen as positive and negative ([can we have better titles](https://michaelharley.net/posts/2026/06/15/bloggers-can-we-make-better-titles-for-our-posts/)) so thought I would document the origins of the week notes term and my WeakNotes alternative.

During the 2010s the [Government](https://gds.blog.gov.uk/tag/week-notes-2/) Digital Service era Digital Service became an evolution, or revolution perhaps, of making services digital first and by [working in the open by default](https://digitalbydefault.com/2025/07/14/make-things-open-reading-list/). Services at the time were not accessible and the [original](https://neilojwilliams.net/about/week-notes/) [staff](https://jordanh.net/gds.html) set about making and showing the thing. The great work over the years were based on a set of principles. Fundamentally this was about working in the open, to show mistakes, learnings and change as it happened and documenting the progress.
...
[Matt Webb had a pre-history of week notes](https://interconnected.org/home/2018/07/24/weeknotes)
...
- [Giles Turnbull sums up the value of week notes](https://gilest.org/doingweeknotes/index.html)

Matt Jukes created the [Weeknot.es](https://weeknot.es/) site to collate and share these collections of weekly updates.
