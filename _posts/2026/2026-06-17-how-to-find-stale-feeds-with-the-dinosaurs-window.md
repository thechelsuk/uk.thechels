...
Lovely new feature from NetNewsWire coming soon, I had mimicked this myself with an OPML export and a Python script to fetch latest and output a markdown table for review on my Mac. Being able to see in app.
