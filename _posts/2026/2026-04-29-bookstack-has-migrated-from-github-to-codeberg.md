...
> The GitHub repository will still be there, but if desired you could update an existing (standard/non-docker) installation to use this Git origin instead of GitHub by running the following from your BookStack install folder:
...
> All existing open GitHub issues and pull requests have been closed.
