...
Thank you for using TheChels.uk! This document explains how to get help with the project.

## How to Get Help

### Issue Tracker

The best way to get help is through the [GitHub issue tracker](https://github.com/thechelsuk/uk.thechels/issues). Before opening a new issue:
...
3. **Provide details** - Include as much relevant information as possible to help us understand and address your issue.
...
1. Check the [issue tracker](https://github.com/thechelsuk/uk.thechels/issues) to see if it's already been reported.
