...
tag: ways
permalink: /ways/use-spare-ugreen-mouse/
...
1. Take the receiver out and insert it into USB port.
2. Turn on the product and the indicator lights on.
3. Randomly click the mouse to make sure it works normally.
...
1. Activate the Bluetooth on the connected device (laptop/tablet/mobile phone, etc.)
2. Turn on the mouse and press the switch button. Bluetooth pairing mode starts when the indicator flashes blue.
3. For first-time use, a window will pop up for Windows 10 or later. Please follow the steps to proceed. For other systems, please enter the Bluetooth devices list, search “UGREEN BLE Mouse” and connect.
4. Randomly click or move the mouse to make sure it works normally.

## Forced Pairing (Bluetooth)
