...
![Hiyd banner](/images/apps/hiyd-banner.png)
...
- Export straight into iCloud Drive, Working Copy, or any folder structure so posts are ready to publish in minutes.
- Companion Chrome extension captures URLs, selected text, and metadata to for quote post style generation.
...
[![Hiyd App Icon](/images/apps/hiyd-icon.png){: .app-icon}](https://apps.apple.com/gb/app/hiyd/id6746853559)
